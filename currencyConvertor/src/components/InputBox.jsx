...
function InputBox({
    ...
    return (
        <div className={`bg-white p-3 rounded-lg text-sm flex justify-between items-center ${className}`}>
            {/* Left Side (Label and Amount Input) */}
            ...
            {/* Right Side (Currency Type Select Box) */}
